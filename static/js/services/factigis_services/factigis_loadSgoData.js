...
function loadCurrentSGOData(callback){
  ...
  qFact.where = "Zona= '" + usrprfl.ZONA_USUARIO + "' AND Estado_tramite='EN TRAMITE' AND TIPO_MEJORA='SGO' AND EMPRESA='" + usrprfl.EMPRESA+ "'";
...
export {loadCurrentSGOData, find_folioData, updateAttributesPerFolio};
